...
if (isset($_POST['submit'])) {
   ...
   $insert = "INSERT INTO bike_form(color, type, size, nb_wheels, quantity, price, image_name, user_email) VALUES('$color','$type','$size','$nb_wheels', '$quantity', '$price', '$filename', '$user_email')";
